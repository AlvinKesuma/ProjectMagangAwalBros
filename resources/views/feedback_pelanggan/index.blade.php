...
@section('title')
Data Rasio Negative Feedback Customer vs Seluruh Feedback yang diterima
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Rasio Negative Feedback Customer vs Seluruh Feedback yang diterima</h4>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Rasio Negative Feedback Customer vs Seluruh Feedback yang diterima</h5>
...
<script>
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('feedback-pelanggan.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Rasio Negative Feedback Customer vs Seluruh Feedback yang diterima";
    }

    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('feedback-pelanggan') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Rasio Negative Feedback Customer vs Seluruh Feedback yang diterima";
