...
@section('title')
Data Waktu Tanggap Operasi Seksio Sesarea Emergensi ≤ 30 Menit
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Waktu Tanggap Operasi Seksio Sesarea Emergensi ≤ 30 Menit</h4>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Waktu Tanggap Operasi Seksio Sesarea Emergensi ≤ 30 Menit</h5>
...
<script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                confirmDeleteButton.onclick = function() {
                    ...
                    form.method = 'POST';
                    form.action = "{{ url('waktu-tanggap-seksi-sesarea') }}/" + itemId;
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('waktu-tanggap-seksi-sesarea.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Waktu Tanggap Operasi Seksio Sesarea Emergensi ≤ 30 Menit";
    ...
    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('waktu-tanggap-seksi-sesarea') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Waktu Tanggap Operasi Seksio Sesarea Emergensi ≤ 30 Menit";
