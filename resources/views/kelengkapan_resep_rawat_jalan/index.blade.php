...
@section('title')
Data Kelengkapan Penulisan Resep Rawat Jalan (Prescribing error)
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Kelengkapan Penulisan Resep Rawat Jalan (Prescribing error)</h4>
                        ...
                        @forelse ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('kelengkapan-resep-rawat-jalan.destroy', $item->id) }}" method="POST" class="d-inline-block delete-form">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Kelengkapan Penulisan Resep Rawat Jalan (Prescribing error)</h5>
...
<script>
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('kelengkapan-resep-rawat-jalan.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Kelengkapan Penulisan Resep Rawat Jalan (Prescribing error)";

        // Autofill unit field with "Farmasi"
        document.getElementById('unit').value = "Farmasi";
    }

    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('kelengkapan-resep-rawat-jalan') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Kelengkapan Penulisan Resep Rawat Jalan (Prescribing error)";
