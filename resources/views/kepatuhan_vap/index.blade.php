...
@section('title')
Data Kepatuhan Penerapan HAIs: VAP
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Kepatuhan Penerapan HAIs: VAP</h4>
                        ...
                        @forelse ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('kepatuhan-vap.destroy', $item->id) }}" method="POST" class="d-inline-block delete-form">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Kepatuhan Penerapan HAIs: VAP</h5>
...
<script>
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('kepatuhan-vap.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Kepatuhan Penerapan HAIs: VAP";
    ...
    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('kepatuhan-vap') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Kepatuhan Penerapan HAIs: VAP";
