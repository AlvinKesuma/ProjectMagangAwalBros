...
@section('title')
Data Pelaporan Hasil Kritis Laboratorium <30 Menit
@endsection
                        ...
                        @forelse ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('hasil-kritislaboratorium.destroy', $item->id) }}" method="POST" class="d-inline-block delete-form">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Pelaporan Hasil Kritis Laboratorium <30 Menitn</h5>
...
<script>
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('hasil-kritislaboratorium.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Pelaporan Hasil Kritis Laboratorium <30 Menit";

        // Autofill unit field with "Kamar Bedah"
        document.getElementById('unit').value = "Labor";
    }

    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('hasil-kritislaboratorium') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Pelaporan Hasil Kritis Laboratorium <30 Menit";
