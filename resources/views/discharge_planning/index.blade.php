...
@section('title')
Data Kesesuaian Discharge Planning DPJP dengan LOS Pasien
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Kesesuaian Discharge Planning DPJP dengan LOS Pasien</h4>
                        ...
                        @forelse ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('discharge-planning.destroy', $item->id) }}" method="POST" class="d-inline-block delete-form">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Kesesuaian Discharge Planning DPJP dengan LOS Pasien</h5>
...
<script>
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('discharge-planning.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Kesesuaian Discharge Planning DPJP dengan LOS Pasien";
    ...
    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('discharge-planning') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Kesesuaian Discharge Planning DPJP dengan LOS Pasien";
