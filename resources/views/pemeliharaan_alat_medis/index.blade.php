...
@section('title')
Data Ketepatan Pemeliharaan Alat Medis High, Medium & Low Risk
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Ketepatan Pemeliharaan Alat Medis High, Medium & Low Risk</h4>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Ketepatan Pemeliharaan Alat Medis High, Medium & Low Risk</h5>
...
<script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                confirmDeleteButton.onclick = function() {
                    ...
                    form.method = 'POST';
                    form.action = "{{ url('pemeliharaan-alat-medis') }}/" + itemId;
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('pemeliharaan-alat-medis.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Ketepatan Pemeliharaan Alat Medis High, Medium & Low Risk";
        
        document.getElementById('unit').value = "Atem";
    }

    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('pemeliharaan-alat-medis') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Ketepatan Pemeliharaan Alat Medis High, Medium & Low Risk";
