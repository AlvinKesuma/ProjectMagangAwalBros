...
@section('title')
Data Monitoring Penanganan Komplain Pasien Rawat Inap
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Monitoring Penanganan Komplain Pasien Rawat Inap</h4>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Monitoring Penanganan Komplain Pasien Rawat Inap</h5>
...
<script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                confirmDeleteButton.onclick = function() {
                    ...
                    form.method = 'POST';
                    form.action = "{{ url('pengelolaan-komplain-pasien') }}/" + itemId;
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('pengelolaan-komplain-pasien.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Monitoring Penanganan Komplain Pasien Rawat Inap";
    ...
    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('pengelolaan-komplain-pasien') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Monitoring Penanganan Komplain Pasien Rawat Inap";
