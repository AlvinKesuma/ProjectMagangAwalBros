...
@section('title')
Data Rata-rata Waktu Tunggu Rawat Jalan 30 Menit
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Rata-rata Waktu Tunggu Rawat Jalan 30 Menit</h4>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Rata-rata Waktu Tunggu Rawat Jalan 30 Menit</h5>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                confirmDeleteButton.onclick = function() {
                    ...
                    form.method = 'POST';
                    form.action = "{{ url('waktu-tunggu-rawat-jalan-30min') }}/" + itemId;
